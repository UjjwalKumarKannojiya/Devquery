    ...
    <section className="relative min-h-screen glass flex flex-col justify-center py-12 px-4">
      ...
      <div className="max-w-2xl w-full mx-auto">
        <GlassCard className="p-8">
          <h1 className="text-4xl font-heading font-bold mb-2 text-foreground">Share Your Feedback</h1>
          ...
          <div className="space-y-8">
            ...
            <div className="border-b border-border pb-8">
              ...
              <form className="space-y-4">
                <div>
                  <label htmlFor="bug-title" className="block text-sm font-medium text-foreground mb-1">
                    Bug Title *
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="bug-description" className="block text-sm font-medium text-foreground mb-1">
                    Description *
                  </label>
                  <textarea
                    id="bug-description"
                ...
                <div>
                  <label htmlFor="bug-steps" className="block text-sm font-medium text-foreground mb-1">
                    Steps to Reproduce
                  </label>
                  <textarea
                    id="bug-steps"
                ...
                <div>
                  <label htmlFor="bug-severity" className="block text-sm font-medium text-foreground mb-1">
                    Severity
                  </label>
                  <select
                    id="bug-severity"
            ...
            {/* Feature Request */}
            <div className="border-b border-border pb-8">
              <h2 className="text-2xl font-semibold text-foreground mb-4">✨ Feature Request</h2>
              <form className="space-y-4">
                <div>
                  <label htmlFor="feature-title" className="block text-sm font-medium text-foreground mb-1">
                    Feature Title *
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="feature-description" className="block text-sm font-medium text-foreground mb-1">
                    Description *
                  </label>
                  <textarea
                ...
                <div>
                  <label htmlFor="feature-usecase" className="block text-sm font-medium text-foreground mb-1">
                    Use Case
                  </label>
                  <textarea
                    id="feature-usecase"
            ...
            {/* General Feedback */}
            <div>
              <h2 className="text-2xl font-semibold text-foreground mb-4">💬 General Feedback</h2>
              <form className="space-y-4">
                <div>
                  <label htmlFor="feedback-type" className="block text-sm font-medium text-foreground mb-1">
                    Feedback Type *
                  </label>
                  <select
                    id="feedback-type"
